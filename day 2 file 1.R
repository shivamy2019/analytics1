...
read111 = read.csv(file="./data/ashu.csv", header = TRUE,sep = ",") #mywork
str(read2) #mywork
...
library(xlsx)
library(rJava)
df_excel1 = read.xlsx( "./data/myexcel.xlsx", 1) #1 here gets you the data on the first sheet, if you change it to 2 it will give the data on the second sheet
df_excel1
